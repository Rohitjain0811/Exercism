...
def approx_average_is_average(hand):
    ...
    if len(hand) % 2 == 1:
        ...
        median = (hand[len(hand)//2 - 1] + hand[len(hand)//2]) / 2

    true_average = card_average(hand)
    return true_average in [ (hand[0] + hand[-1]) / 2, median ]
...
def maybe_double_last(hand):
    ...
    if hand[-1] == 11:  # Jack card value is 11
        hand[-1] = 22  # Double the Jack card value
    return hand
